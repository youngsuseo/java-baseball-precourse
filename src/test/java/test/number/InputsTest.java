...
public class InputsTest {
    ...
    void construct() {
        ...
        Assertions.assertThat(inputList).hasSize(3);
    ...
    void match() {
        ...
        assertAll(
                () -> Assertions.assertThat(match.get(0)).isEqualTo(ScoreEnum.BALL),
                () -> Assertions.assertThat(match.get(1)).isEqualTo(ScoreEnum.BALL),
                () -> Assertions.assertThat(match.get(2)).isEqualTo(ScoreEnum.NONE)
        );
    }
}